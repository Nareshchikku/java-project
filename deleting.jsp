...
<div class="topnav">
  <a  href="#home">Home</a>
		...
		<div class="box"> 
<form action="deleting.jsp" method="get">
...
<button type="submit" name="ok" value="ok">Delete</button>
</form>
<%String o=request.getParameter("ok");
if(o!=null){
	String a=request.getParameter("sn");
	String b=request.getParameter("tod");
	if(Admin.checkexist(a, b)){
		if(Admin.delete(a,b)){ 
			%><font color="green"><%out.print("Scheme sucessfully Deleted");%></font><%
		}else{
